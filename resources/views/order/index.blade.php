                        ...
                        <div class="col-md-4 col-6">
                            <div class="card">
                              ...
                              <div class="card-body pt-2">
                                 ...
                                 @endif
                                 <button type="button" data-id="{{ $product->id }}" class="btn btn-primary btn-sm btn-order" style="width: 100%;" data-bs-toggle="modal" data-bs-target="#exampleModal">Pesan</button>
                              </div>
                           </div>
                        </div>
                        @endforeach
